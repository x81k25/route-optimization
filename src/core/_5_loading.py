...
def load_results_to_files(
    ...
    :param itinerary_df: Detailed route itineraries
    :param aggregate_df: Aggregate analytics data
    :param summary_df: Summary statistics
